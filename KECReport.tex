...
Since we used modified Deffie-Hellman the data and RSA algorithm for securing the data.\cite{sa}
...
\begin{itemize}
	...
	\item The  $K_{a}$ and $K_{b}$ are the shared secret keys and  $K_{a}$ = $K_{b}$ .
\end{itemize}
\begin{figure}[H]
	\centering
