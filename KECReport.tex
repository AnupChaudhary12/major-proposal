...
\newcommand{\projectTitle}{End-To-End Encryption Chat app } %specify "Title" of Your Project
...
\makebox[7cm]{Anup Chaudhary \hfill [38659]}\\
\makebox[7cm]{Chris Gurung \hfill [38672]}\\
\makebox[7cm]{Himalaya Pal \hfill [38678]}\\
\makebox[7cm]{Kundan Giri \hfill [38679]}
...
\newcommand{\defDay}{23} %specify Defense Day- 1, 2, ...

\newcommand{\supervisor}{Er. Bikash Shrestha} % Specify Name of Supervisor for Major Project (write "none" if no Supervisor is assigned)
\newcommand{\degSup}{Sr. Telecom Engineer,\\Nepal Telecom} %Specify Designation of Supervisor for Major Project, use multiple lines (\\) if necessary
...
\begin{figure}[H]
	...
	\caption{DFD level 0} %figure name
	\label{figdfd0} % for referencing
\end{figure}
...
\begin{figure}[H]
	...
	\caption{DFD level 1} %figure name
	\label{figdfd1} % for referencing
\end{figure}
...
\begin{figure}[H]
	...
	\label{figsequence} % for referencing
\end{figure}
\pagebreak
...
\begin{figure}[H]
	...
	\caption{Activity Diagram} %figure name
	\label{figactivity} % for referencing
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Salting Process} %figure name
	\label{Salting} % for referencing
\end{figure}
...
\end{itemize}
A hash function H satisfying all of the above sconditions is called cryptographically strong.
...
\begin{figure}[H]
	...
	\caption{Proposed Algorithm} %figure name
	\label{Proposed Algorithm} % for referencing
\end{figure}
...
\begin{figure}[H]
	...
	\label{figencryptedmsg} % for referencing
\end{figure}
